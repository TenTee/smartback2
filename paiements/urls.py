...
from .views import (
    FormationPaymentPolicyDetailView,
    FormationPaymentPolicyListCreateView,
    PaiementAggregated,
    PaiementDetail,
    PaiementListCreate,
...
urlpatterns = [
    ...
    path("paiements/configurations/", FormationPaymentPolicyListCreateView.as_view(), name="paiement-policy-list"),
    path("paiements/configurations/<int:pk>/", FormationPaymentPolicyDetailView.as_view(), name="paiement-policy-detail"),
